...
if(name && email && phone && password && cpassword !== "" && cheek == true)  
{
      ...
      .then((userCredential) => {
          ...
          setDoc(doc(db,"Gymuser",userCredential.user.uid), {
            Phone:phone,
            Name:name,
            Email:email,
            ID:1 ,
  ...
  return (
    ...
    <CContainer fluid style = {{...page , position: 'relative'}} >
          ...
          height: "68%" , left: "0%" , top:"9%"}}></div>
           ...
           <h1 style={{color: "#FFFFFF" , position: 'absolute' , width: "26%" , left: '37%' , top: '165px',fontSize:"38px"}}>Register For Organization</h1>
