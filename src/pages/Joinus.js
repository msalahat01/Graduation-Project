          ...
          <h1 className="tex1111">JOIN US <br></br> AS</h1>
            <CRow>
              <CCol sm="auto">
                  ...
                  <h1 style = {{position: 'absolute' ,left: "22.5%", color: "#FFFFFF" , top: "22%" }}>GYM ORGANIZAION</h1>
                  <h2 style = {{position: 'absolute',   color: "#FFFFFF" ,fontsize: "100%", width: "12%" , textalign: 'center' ,lineheight:" 125%" , top: "38%", left:"27%"}}
                  ...
                  <Button style = {{position: 'absolute', height:"1.3cm" , width: "19%" ,color:"#252422", borderRadius:"22px"
                   ,backgroundColor: "#EB5E28" ,boxShadow: "3px 3px 2px rgba(46, 46, 46, 0.62)",left: "23%" , top: "64%"}} size="lg" href="/Joinus1"
              ...
              <CCol sm="auto"> 
                  ...
                  <h1 style = {{position: 'absolute' ,right: "20.5%", color: "#FFFFFF" , top: "22%" }}>COACH OR NUTRITION</h1>
                  <h2  style = {{position: 'absolute',   color: "#FFFFFF" ,fontsize: "100%", width: "12%" , textalign: 'center' ,lineheight:" 125%" , top: "38%", right:"27%"}}
                  >Lorem ipsum dolor sit amet, consectetur adipiscing elit. </h2>
                  ...
                  backgroundColor: "#EB5E28" ,boxShadow: "3px 3px 2px rgba(46, 46, 46, 0.62)" ,right: "23%" , top: "64%"}}
                  >Join us</Button> 
              </CCol>
            </CRow>
